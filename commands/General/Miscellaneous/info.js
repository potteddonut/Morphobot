...
module.exports = class extends Command {
	...
	async run(message) {
		...
		return message.channel.sendEmbed(new MessageEmbed()
			...
			.addField('Do I need to know anything to be able to use the bot?', "Morphobot generally does not require you to gain any additional knowledge - it's built to be a user-friendly bot. However, you should minimally know how to retrieve user ID's, as some features require IDs as input.")
			...
			.setFooter(`Morphobot, by Morphoxeris#1111`)
			.setTimestamp());
	}
