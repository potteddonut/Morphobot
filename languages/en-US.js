...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_REBOOT: 'Rebooting Morphobot. This may take a while.',
			...
			COMMAND_INVITE: () => [
				...
				"If you've found any bugs, would like to report an issue, or receive support from Morphobot staff, join our official lounge at <https://discord.gg/WRR2pUt>!"
			],
